...
contract PublicSaleTestnetDeploy is Script {
    ...
    uint256 constant MAX_PER_WALLET = 100000e18;
    int256 constant MOCK_BNB_PRICE = 2000e8; // $2000 BNB
    uint256 constant FALLBACK_TOKEN_PRICE_USD18 = 100000000000000000;
    ...
    function run() external {
        ...
        // 2. Deploy Mock Contracts
        MockERC20 usdt = new MockERC20("Mock USDT", "mUSDT", 18);
        usdt.mint(OWNER,10000e18);
        MockERC20 usdc = new MockERC20("Mock USDC", "mUSDC", 18);
        usdc.mint(OWNER,10000e18);
        MockAggregator bnbUsdFeed = new MockAggregator(MOCK_BNB_PRICE);
        ...
        // 7. Fund and Start
        rcx.transfer(address(sale), 8_000_000e18);
        sale.startSale();
