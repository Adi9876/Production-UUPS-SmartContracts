...
contract PublicSaleDeploy is Script {
    ...
    uint256 constant TOKEN_PRICE_USD18 = 100_000_000_000_000_000; // $0.10 in 18 decimals (fallback price)
    uint256 constant MAX_PER_WALLET = 100_000e18; // 100k RCX max per wallet

    uint256 constant FALLBACK_TOKEN_PRICE_USD18 = 100000000000000000; // $0.10 fallback price
